import CJS_COMPAT_NODE_URL_socn447i47q from 'node:url';
import CJS_COMPAT_NODE_PATH_socn447i47q from 'node:path';
import CJS_COMPAT_NODE_MODULE_socn447i47q from "node:module";

var __filename = CJS_COMPAT_NODE_URL_socn447i47q.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_socn447i47q.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_socn447i47q.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-PHOFBEEP.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-Q3BWRFJJ.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-G2QIBO5W.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-2WVKMVGH.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {

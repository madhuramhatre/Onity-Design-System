...
import {
  compile
} from "./chunk-YTWBZ2EZ.js";
import "./chunk-H3H35PNQ.js";
import "./chunk-ZUK63JMS.js";
import {
  __commonJS,
  __toESM
} from "./chunk-PHOFBEEP.js";
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-Q3BWRFJJ.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-G2QIBO5W.js")).default;
  return {

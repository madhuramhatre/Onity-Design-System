...
import {
  require_picocolors
} from "../_node-chunks/chunk-AILHOSQO.js";
import {
  require_dist
...
var WORKING_DIR = process.cwd(), defaultOptions = {
  ...
  let agent, withinAgenticSetupSession = !1, storybookTestPlugin = {
    ...
    async configureVitest(context) {
      if (context.vitest.config.coverage.exclude.push("storybook-static"), context.vitest.config.browser?.enabled === !0) {
        let setupFilePath = context.vitest.version.startsWith("3") ? "@storybook/addon-vitest/internal/setup-file.browser.3" : "@storybook/addon-vitest/internal/setup-file.browser.4";

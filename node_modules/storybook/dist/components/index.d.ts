...
import { StorybookTheme, CSSObject, FunctionInterpolation } from 'storybook/theming';
...
declare const SyntaxHighlighter$1: {
    ...
    registerLanguage(...args: Parameters<typeof ReactSyntaxHighlighter.registerLanguage>): any;
};
...
declare const LazySyntaxHighlighter: React__default.LazyExoticComponent<(props: ComponentProps<{
    ({ children, language, copyable, bordered, padded, format, formatter, className, showLineNumbers, ...rest }: SyntaxHighlighterProps): React__default.JSX.Element | null;
    registerLanguage(...args: Parameters<any>): any;
...
declare const SyntaxHighlighter: {
    ...
    registerLanguage(...args: Parameters<typeof SyntaxHighlighter$1.registerLanguage>): void;
};
...
declare function useCopyButton<T extends ReactNode>({ children, childrenOnCopy, content, onCopy, ariaLabel, ariaLabelOnCopy, duration, }: UseCopyButtonOptions<T>): UseCopyButtonResult<T>;

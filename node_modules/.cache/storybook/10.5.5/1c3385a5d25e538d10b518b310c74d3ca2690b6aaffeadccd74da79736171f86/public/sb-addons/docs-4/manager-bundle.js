...
`);
  ...
  var ADDON_ID = "storybook/docs", PANEL_ID = `${ADDON_ID}/panel`, PARAM_KEY = "docs", SNIPPET_RENDERED = `${ADDON_ID}/snippet-rendered`, SourceType = ((SourceType2) => (SourceType2.AUTO = "auto", SourceType2.CODE = "code", SourceType2.DYNAMIC = "dynamic", SourceType2))(SourceType || {});
  ...
  var CodePanel = ({
    ...
    useEffect(() => {
      ...
      {
        [SNIPPET_RENDERED]: ({ id, source, format: format2 }) => {
          id !== void 0 && id !== currentStoryId || setSourceCode({ source, format: format2 });
        }
      },
      [currentStoryId]
    );
    ...
    return react_default.createElement(AddonPanel, { active: !!active }, react_default.createElement(SourceStyles, null, react_default.createElement(Source, { ...parameter.source, code, format: codeSnippet.format, dark: isDark })));
  };

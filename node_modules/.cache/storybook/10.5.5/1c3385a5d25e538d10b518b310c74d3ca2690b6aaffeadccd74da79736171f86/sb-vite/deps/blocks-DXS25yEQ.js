import { i as __toESM$1, t as __commonJSMin } from "./rolldown-runtime-B-lAHAz2.js";
import { t as require_react } from "./react.js";
import { t as require_react_dom } from "./react-dom-EpPLNSWr.js";
import { n as getControlSetterButtonId, t as getControlId } from "./chunk-QQBDHPVZ-Bl51WQ3U.js";
import { c as srOnlyUnsetStyles, d as useTheme, h as themes, i as ignoreSsrWarning, l as styled, n as convert, r as ensure, s as srOnlyStyles, t as ThemeProvider, v as require_client_logger } from "./theming-BvdUT4Fj.js";
import { a as __toESM$2, r as __commonJS$1, t as dedent$1 } from "./chunk-3LY4VQVK-2iHdYYb0.js";
import { A as pickBy$1, B as LinkIcon, D as require_preview_errors, E as require_channels, F as ChevronSmallDownIcon, G as UndoIcon, H as ShareAltIcon, I as ChevronSmallUpIcon, J as ZoomResetIcon, K as ZoomIcon, L as CopyIcon, M as AddIcon, N as ChevronDownIcon$1, O as require_core_events, P as ChevronRightIcon, R as DocumentIcon, S as withReset, T as require_preview_api$1, U as SubtractIcon, V as MarkupIcon, W as SyncIcon, _ as Zoom, a as ErrorFormatter, c as H3, d as PopoverProvider, f as ResetWrapper, g as Toolbar$1, h as ToggleButton, i as EmptyTabContent, j as isPlainObject, k as mapValues, l as Link2, m as TabsView, n as Button, o as Form, p as SyntaxHighlighter, q as ZoomOutIcon, r as Code, s as H2, t as Bar, u as Loader, v as codeCommon, w as includeConditionalArg, x as nameSpaceClassNames, y as components2, z as EditIcon } from "./components-4K44-mUU.js";
import { n as useMDXComponents } from "./react-CebqJi_1.js";
//#region node_modules/storybook/dist/_browser-chunks/chunk-QC4HFS6K.js
...
//#endregion
//#region node_modules/storybook/dist/_browser-chunks/chunk-GWNTJ7C3.js
...
var filterArgTypes$1 = (argTypes, include, exclude) => !include && !exclude ? argTypes : argTypes && pickBy$1(argTypes, (argType, key) => {
...
var inferControls = (context) => {
	...
	let filteredArgTypes = filterArgTypes$1(argTypes, include, exclude);
...
var inferType = (value, name, visited, cache) => {
	...
	if (value) {
		...
		if (visited.has(value)) return import_client_logger.logger.warn(dedent$1`
...
var require_dist = __commonJS$1({ "../../node_modules/jsdoc-type-pratt-parser/dist/index.js"(exports, module) {
...
var jsdocStringifyRules = (0, __toESM$2(require_dist(), 1).stringifyRules)();
...
var EmptyBlock = (props) => import_react.createElement(Wrapper$1, {
	...props,
...
var SourceSkeleton = () => import_react.createElement(SourceSkeletonWrapper, null, import_react.createElement(SourceSkeletonPlaceholder, null), import_react.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), import_react.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), import_react.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }));
var Source = ({ isLoading, error, language, code, dark, format: format2 = !0, copyable = !0, ...rest }) => {
...
var Label = styled.label(({ theme }) => getBooleanControlStyles(theme));
var parse = (value) => value === "true";
var BooleanControl = ({ name, storyId, controlsId, value, onChange, onBlur, onFocus, argType, required }) => {
...
var DateControl = ({ name, storyId, controlsId, value, onChange, onFocus, onBlur, argType, required }) => {
...
var Wrapper = styled.label({ display: "flex" });
var parse2 = (value) => {
	let result = parseFloat(value);
	return Number.isNaN(result) ? void 0 : result;
};
var format = (value) => value != null ? String(value) : "";
var FormInput2 = styled(Form.Input)(({ theme }) => ({ background: theme.base === "light" ? theme.color.lighter : "transparent" }));
var NumberControl = ({ name, storyId, controlsId, value, onChange, min, max, step, onBlur, onFocus, argType, required }) => {
...
var Text = styled.span(({ $readOnly }) => ({ opacity: $readOnly ? .5 : 1 }));
...
var CheckboxControl = ({ name, storyId, controlsId, options, value, onChange, isInline, argType, required }) => {
	...
	let initial2 = selectedKeys(value || [], options), [selected, setSelected] = (0, import_react.useState)(initial2), readonly = !!argType?.table?.readonly, handleChange = (e2) => {
	...
	return import_react.createElement(Wrapper2, { $isInline: isInline }, import_react.createElement("legend", { className: "sb-sr-only" }, name, required ? " (required)" : ""), Object.keys(options).map((key, index) => {
...
var Text2 = styled.span(({ $readOnly }) => ({ opacity: $readOnly ? .5 : 1 }));
...
var RadioControl = ({ name, storyId, controlsId, options, value, onChange, isInline, argType, required }) => {
	...
	return import_react.createElement(Wrapper3, { isInline }, import_react.createElement("legend", { className: "sb-sr-only" }, name, required ? " (required)" : ""), Object.keys(options).map((key, index) => {
		let id = `${controlId}-${index}`;
...
var SingleSelect = ({ name, storyId, controlsId, value, options, onChange, argType, required }) => {
	let handleChange = (e2) => {
...
var MultiSelect = ({ name, storyId, controlsId, value, options, onChange, argType, required }) => {
	let handleChange = (e2) => {
...
var Region = styled.div({ display: "inline" });
...
var JsonFunctionValue = class extends import_react.Component {
	...
	render() {
		...
		if (editEnabled && !resultOnlyResult) {
			let textareaElement = textareaElementGenerator(VALUE, comeFromKeyPath, deep, name, originalValue, dataType), textareaElementLayout = (0, import_react.cloneElement)(textareaElement, {
				ref: this.refInput,
				defaultValue: value,
				onKeyDown: this.onKeydown
			});
...
var { window: globalWindow } = globalThis, Wrapper4 = styled.div(({ theme }) => ({
	...
	let data = (0, import_react.useMemo)(() => value && cloneDeep(value), [value]), hasData = data != null, [showRaw, setShowRaw] = (0, import_react.useState)(!hasData), hadDataRef = (0, import_react.useRef)(hasData), [parseError, setParseError] = (0, import_react.useState)(null), readonly = !!argType?.table?.readonly, updateRaw = (0, import_react.useCallback)((raw) => {
		try {
	...
	let htmlElRef = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
		forceVisible && htmlElRef.current && htmlElRef.current.select();
	}, [forceVisible]);
	...
	let rawInputId = getControlId(name, storyId, controlsId), rawJSONForm = import_react.createElement(import_react.Fragment, null, import_react.createElement("label", {
		htmlFor: rawInputId,
		className: "sb-sr-only"
	}, "Edit ", name, " as JSON"), import_react.createElement(RawInput, {
		ref: htmlElRef,
		id: rawInputId,
		minRows: 3,
		name,
...
var RangeControl = ({ name, storyId, controlsId, value, onChange, min = 0, max = 100, step = 1, onBlur, onFocus, argType, required }) => {
	let handleChange = (event) => {
		onChange(parse2(event.target.value));
	}, hasValue = value !== void 0, numberOFDecimalsPlaces = (0, import_react.useMemo)(() => getNumberOfDecimalPlaces(step), [step]), readonly = !!argType?.table?.readonly, controlId = getControlId(name, storyId, controlsId);
...
var Wrapper5 = styled.label({ display: "flex" });
var MaxLength = styled.div(({ isMaxed }) => ({
	marginLeft: "0.75rem",
	paddingTop: "0.35rem",
	color: isMaxed ? "red" : void 0
}));
var TextControl = ({ name, storyId, controlsId, value, onChange, onFocus, onBlur, maxLength, argType, required }) => {
	let handleChange = (event) => {
...
var FilesControl = ({ onChange, name, storyId, controlsId, accept = "image/*", value, argType, required }) => {
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6AOWCN3U-BjAq0Tm_.js"));
var ColorControl = (props) => import_react.createElement(import_react.Suspense, { fallback: import_react.createElement("div", null) }, import_react.createElement(LazyColorControl, { ...props }));
var Controls2 = {
	array: ObjectControl,
...
var NoControl = () => import_react.createElement(import_react.Fragment, null, "-");
var ArgControl = ({ row, arg, updateArgs, isRequired, storyId, controlsId }) => {
	...
	if (!control || control.disable) return control?.disable !== !0 && row?.type?.name !== "function" ? import_react.createElement(import_react.Fragment, null, import_react.createElement("span", { className: "sbdocs sbdocs-argcontrol-setup" }, import_react.createElement(Link2, {
		href: "https://storybook.js.org/docs/essentials/controls?ref=ui",
		target: "_blank",
		withArrow: !0
	}, "Setup controls")), import_react.createElement("span", { className: "sbdocs sbdocs-argcontrol-placeholder" }, import_react.createElement(NoControl, null))) : import_react.createElement(NoControl, null);
	let props = {
		name: key,
		storyId,
		controlsId,
...
var Text3 = styled.span(codeCommon, ({ theme, simple = !1 }) => ({
	flex: "0 0 auto",
	fontFamily: theme.typography.fonts.mono,
	fontSize: theme.typography.size.s1,
...
var ChevronUpIcon = styled(ChevronSmallUpIcon)({ marginLeft: 4 });
var ChevronDownIcon = styled(ChevronSmallDownIcon)({ marginLeft: 4 });
var EmptyArg = () => import_react.createElement("span", null, "-");
var ArgText = ({ text, simple }) => import_react.createElement(Text3, { simple }, text);
var getSummaryItems = (summary) => {
	if (!summary) return [summary];
	return uniq(summary.split("|").map((value) => value.trim()));
};
var renderSummaryItems = (summaryItems) => summaryItems.slice(0, ITEMS_BEFORE_EXPANSION).map((item) => import_react.createElement(ArgText, {
	key: item,
	text: item === "" ? "\"\"" : item
}));
var renderExpandedItems = (summaryItems) => summaryItems.slice(ITEMS_BEFORE_EXPANSION).map((item) => import_react.createElement(ArgText, {
	key: item,
	text: item === "" ? "\"\"" : item
}));
...
var ArgValue = ({ value, initialExpandedArgs }) => value == null ? import_react.createElement(EmptyArg, null) : import_react.createElement(ArgSummary, {
	value,
	initialExpandedArgs
});
...
var StyledTd = styled.td(({ expandable }) => ({ paddingLeft: expandable ? "40px !important" : "20px !important" }));
...
var ArgRow = (props) => {
	...
	return import_react.createElement(StyledTr, null, import_react.createElement(StyledTd, { expandable: expandable ?? !1 }, import_react.createElement(Name, null, name), required ? import_react.createElement(Required, {
		"aria-hidden": !0,
		title: "Required"
	}, "*") : null), compact2 ? null : import_react.createElement("td", null, hasDescription && import_react.createElement(Description, { lang: docsLang }, import_react.createElement(index_modern_default, null, description)), table.jsDocTags != null ? import_react.createElement(import_react.Fragment, null, import_react.createElement(TypeWithJsDoc, { hasDescription }, import_react.createElement(ArgValue, {
		value: type,
		initialExpandedArgs
...
var Empty = ({ inAddonPanel }) => {
	...
	return (0, import_react.useEffect)(() => {
		...
		description: import_react.createElement(import_react.Fragment, null, "Storybook couldn't find or generate any controls for this story. Define", " ", import_react.createElement("code", null, "args"), " or ", import_react.createElement("code", null, "argTypes"), ", or configure docgen to let Storybook generate controls automatically."),
		footer: import_react.createElement(Links, null, import_react.createElement(Link2, {
			href: "https://storybook.js.org/docs/essentials/controls?ref=ui",
			target: "_blank",
			withArrow: !0
		}, import_react.createElement(DocumentIcon, null), " Read docs"))
	}));
};
...
var StyledTd2 = styled.td({ position: "relative" });
var StyledTr2 = styled.tr(({ theme }) => ({ "&:hover > td": {
...
var SectionRow = ({ level = "section", label, children, initialExpanded = !0, colSpan = 3 }) => {
	...
	return import_react.createElement(import_react.Fragment, null, import_react.createElement(StyledTr2, { title: helperText }, import_react.createElement(Level, { colSpan: 1 }, import_react.createElement(ClickIntercept, {
...
var Column = styled.div(({ position, theme }) => {
	let baseStyles = {
		display: "flex",
		flexDirection: "column",
		gap: 5,
...
var SkeletonText = styled.div(({ theme, width, height }) => ({
	animation: `${theme.animation.glow} 1.5s ease-in-out infinite`,
	background: theme.appBorderColor,
	width: width || "100%",
	height: height || 16,
...
var Skeleton = () => import_react.createElement(TableWrapper, null, import_react.createElement(Row, null, import_react.createElement(Column, { position: "first" }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { position: "second" }, import_react.createElement(SkeletonText, { width: "30%" })), import_react.createElement(Column, { position: "third" }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { position: "last" }, import_react.createElement(SkeletonText, { width: "60%" }))), import_react.createElement(Row, null, import_react.createElement(Column, { position: "first" }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { position: "second" }, import_react.createElement(SkeletonText, { width: "80%" }), import_react.createElement(SkeletonText, { width: "30%" })), import_react.createElement(Column, { position: "third" }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { position: "last" }, import_react.createElement(SkeletonText, { width: "60%" }))), import_react.createElement(Row, null, import_react.createElement(Column, { position: "first" }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { position: "second" }, import_react.createElement(SkeletonText, { width: "80%" }), import_react.createElement(SkeletonText, { width: "30%" })), import_react.createElement(Column, { position: "third" }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { position: "last" }, import_react.createElement(SkeletonText, { width: "60%" }))), import_react.createElement(Row, null, import_react.createElement(Column, { position: "first" }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { position: "second" }, import_react.createElement(SkeletonText, { width: "80%" }), import_react.createElement(SkeletonText, { width: "30%" })), import_react.createElement(Column, { position: "third" }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { position: "last" }, import_react.createElement(SkeletonText, { width: "60%" }))));
...
var TablePositionWrapper = styled.div({ position: "relative" });
var ButtonPositionWrapper = styled.div({
	position: "absolute",
	right: 22,
	top: 10
});
var StyledButton = styled(Button)({ margin: "-4px -12px -4px 0" });
var sortFns = {
...
var DocsPageWrapper = ({ children, toc, lang = "en" }) => import_react.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, toc, import_react.createElement(DocsContent, {
...
var $b5e257d569688ac6$var$SSRContext = import_react.createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = import_react.createContext(!1);
...
var MDX_WRAPPED_BLOCK = /* @__PURE__ */ Symbol("mdxWrappedBlock");
var MdxWrappedBlockContext = import_react.createContext(null);
...
var getStoryId = (props, context) => {
	let { of, meta } = props;
	if ("of" in props && of === void 0) throw new import_preview_errors.InvalidBlockOfPropError();
...
var IFrameStory = ({ story, height = "500px" }) => import_react.createElement("div", { style: {
	width: "100%",
	height
...
var ErrorMessage = styled.strong(({ theme }) => ({ color: theme.color.orange }));
var Story = (props) => {
...
var StorySkeleton = () => import_react.createElement(Loader, null);
...
var Toolbar = ({ isLoading, storyId, zoom, resetZoom, onReloadStory, ...rest }) => import_react.createElement(AbsoluteBar, {
	innerStyle: {
		gap: 4,
		paddingInline: 7,
	...
	2,
	3
].map((key) => import_react.createElement(IconPlaceholder, { key })) : import_react.createElement(import_react.Fragment, null, onReloadStory && import_react.createElement(Button, {
	padding: "small",
	variant: "ghost",
	key: "reload",
	onClick: onReloadStory,
	ariaLabel: "Reload story"
}, import_react.createElement(SyncIcon, null)), import_react.createElement(Button, {
	padding: "small",
	variant: "ghost",
	key: "zoomin",
	onClick: (e2) => {
...
var PreviewContainer = styled.div(({ theme }) => ({
	position: "relative",
	overflow: "hidden",
	margin: "25px 0 40px",
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = !1, isExpanded = !1, additionalActions, className, layout = "padded", inline = !1, onReloadStory, ...props }) => {
	let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), [copied, setCopied] = (0, import_react.useState)(null), [scale, setScale] = (0, import_react.useState)(1), additionalActionItems = (0, import_react.useMemo)(() => additionalActions ? [...additionalActions] : [], [additionalActions]), sourceId = $bdb11010cef70236$export$f680877a34711e37(), previewClasses = [className].concat([
		...
		let { createCopyToClipboardFunction } = await import("./components-4K44-mUU.js").then((n) => n.b);
	...
	}, import_react.createElement(CopyIcon, null), " ", copied ?? "Copy code")), additionalActionItems.map(({ title, ariaLabel, className: className2, onClick, disabled }, index) => import_react.createElement(Button, {
		key: index,
...
var StyledTabsView = styled(TabsView)({ height: "fit-content" });
var TabbedArgsTable = ({ tabs, ...props }) => {
	...
	let tabsFromEntries = entries.map(([label, table], index) => {
		...
		return {
			...
			title: label,
			children: import_react.createElement(ArgsTable, {
				inTabPanel: !0,
				...table,
				...argsTableProps
			})
...
var Typeset = ({ fontFamily, fontSizes, fontWeight, sampleText, ...props }) => import_react.createElement(Wrapper8, {
	...props,
...
var ItemSubtitle = styled.div(({ theme }) => ({ color: curriedTransparentize$1(.3, theme.color.defaultText) }));
...
var ColorItem = ({ title, subtitle, colors }) => import_react.createElement(Item, null, import_react.createElement(ItemDescription, null, import_react.createElement(ItemTitle, null, title), import_react.createElement(ItemSubtitle, null, subtitle)), import_react.createElement(Swatches, null, renderSwatchSpecimen(colors)));
var ColorPalette = ({ children, ...props }) => import_react.createElement(ResetWrapper, null, import_react.createElement(List, {
	...props,
...
var IconItem = ({ name, children }) => import_react.createElement(Item2, null, import_react.createElement(ItemSpecimen, null, children), import_react.createElement(ItemLabel, null, name));
var IconGallery = ({ children, ...props }) => import_react.createElement(ResetWrapper, null, import_react.createElement(List2, {
	...props,
...
var Title2 = ({ headingId, title }) => typeof title == "string" || !title ? import_react.createElement(Heading, {
	as: "h2",
	id: headingId,
	className: title ? "" : "sb-sr-only",
	lang: title ? void 0 : "en"
}, title || "Table of contents") : import_react.createElement("div", { id: headingId }, title);
...
var Anchor = ({ storyId, children }) => import_react.createElement("div", {
	id: anchorBlockIdFromId(storyId),
	className: "sb-anchor"
}, children);
function useSyncExternalStoreShim(subscribe, getSnapshot) {
	let value = getSnapshot(), [{ inst }, forceUpdate] = (0, import_react.useState)({ inst: {
		value,
		getSnapshot
	} });
	return (0, import_react.useLayoutEffect)(() => {
		...
		value,
		getSnapshot
	]), (0, import_react.useEffect)(() => (didSnapshotChange(inst) && forceUpdate({ inst }), subscribe(() => {
...
function useQuerySubscription(cacheKey, query, input, selector) {
	let cache = (0, import_react.useRef)(void 0);
	...
	let inputRef = (0, import_react.useRef)(input);
	inputRef.current = input;
	return useSyncExternalStoreShim((0, import_react.useCallback)((listener) => {
		...
		cacheKey,
		selector
	]), (0, import_react.useCallback)(() => cache.current.state, []));
}
function useServiceDocgen(id) {
	return useQuerySubscription(id, (0, import_preview_api.getService)("core/docgen").queries.docgen, { id });
}
...
function useResolveArgTypes(props) {
	let { of } = props;
	if ("of" in props && of === void 0) throw new import_preview_errors.InvalidBlockOfPropError();
	let context = (0, import_react.useContext)(DocsContext), resolved = useOf(of || "meta"), resolvedArgTypes;
...
function renderArgTypesTables({ mainName = "Main", mainRows, subcomponentRows, include, exclude, sort, docsLang }) {
	let filteredMainRows = (0, import_preview_api.filterArgTypes)(mainRows, include, exclude);
	if (Object.keys(subcomponentRows).length === 0) return import_react.createElement(ArgsTable, {
	...
	let tabs = {
		...
		...Object.fromEntries(Object.entries(subcomponentRows).map(([key, rows]) => [key, {
			rows: (0, import_preview_api.filterArgTypes)(rows, include, exclude),
			sort
		}]))
	};
...
var DocgenServiceArgTypes = (props) => {
	...
	return isInitialLoading ? import_react.createElement(ArgsTable, { isLoading: !0 }) : serviceRows ? renderArgTypesTables({
...
var ArgTypesImpl = (props) => globalThis.FEATURES?.experimentalDocgenServer ? import_react.createElement(DocgenServiceArgTypes, { ...props }) : import_react.createElement(LegacyArgTypes, { ...props });
...
var require_shams = __commonJS({ "node_modules/.pnpm/has-symbols@1.1.0/node_modules/has-symbols/shams.js"(exports, module) {
	"use strict";
...
var require_call_bound = __commonJS({ "node_modules/.pnpm/call-bound@1.0.4/node_modules/call-bound/index.js"(exports, module) {
	"use strict";
...
var require_shams2 = __commonJS({ "node_modules/.pnpm/has-tostringtag@1.0.2/node_modules/has-tostringtag/shams.js"(exports, module) {
	"use strict";
...
var require_is_regex = __commonJS({ "node_modules/.pnpm/is-regex@1.2.1/node_modules/is-regex/index.js"(exports, module) {
	"use strict";
...
var require_is_function = __commonJS({ "node_modules/.pnpm/is-function@1.0.2/node_modules/is-function/index.js"(exports, module) {
...
var require_safe_regex_test = __commonJS({ "node_modules/.pnpm/safe-regex-test@1.1.0/node_modules/safe-regex-test/index.js"(exports, module) {
	"use strict";
...
var require_is_symbol = __commonJS({ "node_modules/.pnpm/is-symbol@1.1.1/node_modules/is-symbol/index.js"(exports, module) {
	"use strict";
...
function useServiceStory(storyId, selector) {
	let componentId = storyId.split("--")[0], service = (0, import_preview_api.getService)("core/story-docs"), boundSelector = (0, import_react.useCallback)((payload) => selector(payload, storyId), [selector, storyId]);
...
var EMPTY_SOURCE_CONTEXT = { sources: {} };
...
var useCode = ({ snippet, serviceSnippet, storyContext, typeFromProps, transformFromProps }) => {
...
var useSourceProps = (props, docsContext, sourceContext, serviceSnippet = "") => {
...
var SourceWithStoryDocsSnippet = ({ storyId, docsContext, sourceContext, ...props }) => {
...
var SourceWithStorySnippet = (props) => {
	let { of } = props, sourceContext = (0, import_react.useContext)(SourceContext), docsContext = (0, import_react.useContext)(DocsContext), story = (0, import_react.useMemo)(() => {
		if (of) return docsContext.resolveOf(of, ["story"]).story;
		try {
			return docsContext.storyById();
		} catch {}
	}, [docsContext, of]);
	if (globalThis.FEATURES?.experimentalDocgenServer && story?.id) return import_react.createElement(SourceWithStoryDocsSnippet, {
		...props,
		docsContext,
		sourceContext,
		storyId: story.id
...
var SourceWithCode = (props) => {
	let sourceProps = useSourceProps(props, (0, import_react.useContext)(DocsContext), EMPTY_SOURCE_CONTEXT);
	return import_react.createElement(Source, { ...sourceProps });
};
var SourceImpl = (props) => props.code !== void 0 ? import_react.createElement(SourceWithCode, { ...props }) : import_react.createElement(SourceWithStorySnippet, { ...props });
...
var usePrimaryStory = () => {
	let context = (0, import_react.useContext)(DocsContext), stories = context.componentStories();
	return context.filterByAutodocs === !1 ? stories[0] : stories.find((story) => story.tags.includes(import_preview_api$1.Tag.AUTODOCS));
};
...
var ControlsTables = ({ mainName = "Story", mainRows, subcomponentRows, include, exclude, sort, storyId, controlsId, args, globals, updateArgs, resetArgs, docsLang }) => {
	let filteredMainRows = (0, import_preview_api.filterArgTypes)(mainRows, include, exclude);
	if (Object.keys(subcomponentRows).length === 0) return Object.keys(filteredMainRows).length > 0 || Object.keys(args).length > 0 ? import_react.createElement(ArgsTable, {
		storyId,
		controlsId,
		rows: filteredMainRows,
		sort,
...
var LegacyControls = ({ story, context, ...props }) => {
	...
	return argTypes ? import_react.createElement(ControlsTables, {
...
var DocgenServiceControls = ({ story, context, ...props }) => {
	...
	return isInitialLoading ? import_react.createElement(ArgsTable, { isLoading: !0 }) : serviceRows ? import_react.createElement(ControlsTables, {
		mainName: getComponentName(component) ?? serviceRows.serviceComponentName,
		mainRows: serviceRows.mainRows,
		subcomponentRows: serviceRows.subcomponentRows,
		...filterProps,
...
var ControlsImpl = (props) => {
	...
	return globalThis.FEATURES?.experimentalDocgenServer ? import_react.createElement(DocgenServiceControls, { ...storyProps }) : import_react.createElement(LegacyControls, { ...storyProps });
};
...
var OcticonHeaders = SUPPORTED_MDX_HEADERS.reduce((acc, headerType) => ({
	...acc,
	[headerType]: styled(headerType)({})
}), {});
var OcticonAlignmentWrapper = styled.span({
	display: "block",
	position: "relative",
	"& svg": { visibility: "hidden" },
	"&:hover svg, &:focus-within svg": { visibility: "visible" }
});
var OcticonAnchorWrapper = styled.span({
	position: "absolute",
	top: "50%",
	right: "100%",
	lineHeight: "inherit",
...
var HeaderWithOcticonAnchor = ({ as, id, children, ...rest }) => {
	...
	return import_react.createElement(OcticonHeader, {
		id,
		...rest
	}, import_react.createElement(OcticonAlignmentWrapper, { className: "sb-unstyled" }, import_react.createElement(OcticonAnchorWrapper, null, import_react.createElement(Button, {
		asChild: !0,
		variant: "ghost",
		size: "small",
		padding: "small",
...
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce((acc, headerType) => ({
	...acc,
...
var DescriptionType = /* @__PURE__ */ ((DescriptionType2) => (DescriptionType2.INFO = "info", DescriptionType2.NOTES = "notes", DescriptionType2.DOCGEN = "docgen", DescriptionType2.AUTO = "auto", DescriptionType2))(DescriptionType || {});
var getDescriptionFromResolvedOf = (resolvedOf, serviceComponentDescription, storyDocsDescription) => {
...
var DescriptionBody = ({ resolvedOf, serviceComponentDescription, lang, storyDocsDescription }) => {
	let markdown = getDescriptionFromResolvedOf(resolvedOf, serviceComponentDescription, storyDocsDescription);
	return markdown ? import_react.createElement(Markdown, { lang }, markdown) : null;
};
var DescriptionStoryWithServices = ({ resolvedOf }) => {
	...
	return import_react.createElement(DescriptionBody, {
		resolvedOf,
		storyDocsDescription,
		lang
	});
};
var DescriptionComponentWithServices = ({ resolvedOf, componentId }) => {
...
var DescriptionImpl = (props) => {
	let { of } = props, context = (0, import_react.useContext)(DocsContext);
	if ("of" in props && of === void 0) throw new import_preview_errors.InvalidBlockOfPropError();
	let resolvedOf = useOf(of || "meta");
	if (globalThis.FEATURES?.experimentalDocgenServer) {
		if (resolvedOf.type === "story") return import_react.createElement(DescriptionStoryWithServices, { resolvedOf });
		let componentId = resolvedOf.type === "meta" ? resolvedOf.preparedMeta.componentId : context.getComponentId(resolvedOf.component);
		if (componentId) return import_react.createElement(DescriptionComponentWithServices, {
			resolvedOf,
			componentId
		});
	}
...
var createDocsSlugger = () => new BananaSlug();
var DocsSluggerContext = (0, import_react.createContext)(null);
var { document: document3, window: globalWindow3 } = globalThis, DocsContainer = ({ context, theme, children }) => {
	let slugger = (0, import_react.useMemo)(() => createDocsSlugger(), []), toc, lang;
	try {
	...
	}), import_react.createElement(DocsSluggerContext.Provider, { value: slugger }, import_react.createElement(DocsContext.Provider, { value: context }, import_react.createElement(SourceContainer, { channel: context.channel }, import_react.createElement(ThemeProvider, { theme: ensure(theme) }, import_react.createElement(DocsPageWrapper, {
		lang,
		toc: toc ? import_react.createElement(TableOfContents, {
...
var HeadingImpl = ({ children, disableAnchor, ...props }) => {
	if (disableAnchor || typeof children != "string") return import_react.createElement(H2, null, children);
	let tagID = (import_react.useContext(DocsSluggerContext) ?? slugs).slug(children.toLowerCase());
...
var StoriesImpl = ({ title = "Stories", includePrimary = !0 }) => {
	let { componentStories, projectAnnotations, getStoryContext } = (0, import_react.useContext)(DocsContext), stories = componentStories(), filter = projectAnnotations.parameters?.docs?.stories?.filter;
...
function ExternalDocs({ projectAnnotationsList, children }) {
	(0, import_client_logger.deprecate)("ExternalDocs is deprecated and will be removed in Storybook 11.");
...
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => ((0, import_client_logger.deprecate)("ExternalDocsContainer is deprecated and will be removed in Storybook 11."), preview || (preview = new ExternalPreview(projectAnnotations)), import_react.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
	let context = (0, import_react.useContext)(DocsContext);
...
var WrapperImpl = ({ children }) => import_react.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
var Wrapper9 = withMdxComponentOverride("Wrapper", WrapperImpl);
var PRIMARY_STORY = "^";
//#endregion
export { assertIsFn as $, Meta as A, Stories as B, FilesControl as C, IconGallery as D, Heading2 as E, Primary as F, TextControl as G, Subheading as H, RangeControl as I, UNKNOWN_ARGS_HASH as J, Title3 as K, Source2 as L, ObjectControl as M, OptionsControl as N, IconItem as O, PRIMARY_STORY as P, argsHash as Q, SourceContainer as R, ExternalDocsContainer as S, HeadersMdx as T, Subtitle2 as U, Story2 as V, TableOfContents as W, Wrapper9 as X, Unstyled as Y, anchorBlockIdFromId as Z, DocsContainer as _, ArgsTable as a, getStoryProps as at, DocsStory as b, CodeOrSourceMdx as c, parseDate as ct, ColorPalette as d, useOf as dt, extractTitle as et, Controls3 as f, useSourceProps as ft, Docs as g, DescriptionType as h, ArgTypes as i, getStoryId as it, NumberControl as j, Markdown as k, ColorControl as l, parseTime as lt, Description2 as m, Anchor as n, formatDate as nt, BooleanControl as o, normalizeOptions as ot, DateControl as p, Typeset as q, AnchorMdx as r, formatTime as rt, Canvas as s, parse2 as st, AddContext as t, format as tt, ColorItem as u, slugs as ut, DocsContext as v, HeaderMdx as w, ExternalDocs as x, DocsPage as y, SourceContext as z };

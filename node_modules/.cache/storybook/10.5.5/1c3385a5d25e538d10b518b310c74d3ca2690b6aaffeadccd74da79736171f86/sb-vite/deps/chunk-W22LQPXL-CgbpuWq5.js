...
import { l as styled } from "./theming-BvdUT4Fj.js";
...
//#endregion
//#region node_modules/storybook/dist/_browser-chunks/chunk-W22LQPXL.js
...
var Primitive = [
	...
	let Node = import_react.forwardRef((props, forwardedRef) => {
		...
		return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = !0), (0, import_jsx_runtime.jsx)(Comp, {
			...primitiveProps,
			ref: forwardedRef
		});
	});
...
var ScrollAreaViewport2 = styled(Viewport)(({ focusable, theme }) => ({
	width: "100%",
	height: "100%",
	"&:focus": focusable ? {
...
var ScrollArea2 = (0, import_react.forwardRef)(({ children, horizontal = !1, vertical = !1, offset = 2, scrollbarSize = 6, scrollPadding = 0, className, focusable = !1 }, ref) => import_react.createElement(ScrollAreaRoot, {
...
//#endregion
export { $319e236875307eab$export$a9b970dcc4ae71a9 as i, ScrollArea2 as n, useCopyButton as r, ActionBar as t };
